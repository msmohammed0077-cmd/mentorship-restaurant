...
- [`src/main/resources/application.properties`](./src/main/resources/application.properties): datasource and JPA config
...
- [`src/main/java/com/mentorship/restaurant/persistence/entity`](./src/main/java/com/mentorship/restaurant/persistence/entity): JPA entities
